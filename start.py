...
TOKEN = 'NDk4NTE2NzgyNDM3MzY3ODA4.D1RhRw.l039_nAh9tvXIk9bo49IQSeW4Rg'
...
async def random_gif():
  """send you random gif"""
  data = json.loads(urllib.request.urlopen("http://api.giphy.com/v1/gifs/random?api_key=tim6kjLJJecFkBrRJLmZ1GBjCIOk2E8h").read())
  dicts = data
  dicts2 = dicts['data']
  url = dicts2['url']
  await bot.say(url)
